...
import img2 from "../../public/images/crystacar.png";
import img3 from "../../public/images/innovacar.png";
...
const Cars = React.forwardRef(
  ({ featuredCarSection, handleRentNowClick }, ref) => {
    ...
    return (
      <>
        <Container>
          ...
          <section
            // className="featured-car py-12 md:px-8 md:py-20 bg-gradient-to-r from-[#0b1c3a]/90 via-[#0b1c3a]/70 to-[#0b1c3a]/90 "
            className="featured-car py-12 md:px-8 md:py-20 bg-black "
            id="featured-car"
            ref={featuredCarSection}
            ...
            <div className="container mx-auto">
              ...
              <div className="cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:mx-3">
                {cars.map((car, index) => (
                  <div
                    key={index}
                    className="border border-white rounded-[25px] bg-white/90 p-4 shadow-md mx-4 md:mx-0 flex flex-col justify-between h-full"
                  >
                    <img
                      src={car.image}
                      alt={car.name}
                      className="car-image mb-4 w-full h-48 md:h-[55%] lg:h-52 object-cover rounded-[25px]"
                    />
                    <div className="flex flex-col justify-between flex-grow">
                      <div>
                        <div className="flex justify-between items-center mx-2">
                          ...
                          <p className="text-gray-600 border border-yellow-500 rounded-full px-4 py-1 border-dashed">
                            {car.model}
                          </p>
                        </div>
                        <div className="flex justify-between items-center mt-2 md:mt-5 mx-2">
                          <div className="text-gray-600 flex items-center text-lg w-40">
                            <BsPeople className="text-yellow-600 md:text-2xl mr-2" />
                            <p className="ml-1 text-[15px] text-gray-600">
                              {car.seater} Seats
                            </p>
                          </div>
                          <div className="text-gray-600 flex items-center text-lg w-40">
                            <LuFuel className="text-yellow-600 md:text-2xl mr-2" />
                        ...
                        <div className="flex justify-between items-center mt-2 md:mt-5 mx-2">
                          <div className="text-gray-600 flex items-center text-lg w-40">
                            <LiaRupeeSignSolid className="text-yellow-600 md:text-2xl mr-2" />
                            <p className="text-[15px]">{car.rate} per/Km</p>
                          </div>
                          <div className="text-gray-600 flex items-center text-lg w-40">
                            <PiFan className="text-yellow-600 md:text-2xl mr-2" />
                      ...
                      <div className="customer-clicks flex justify-between mx-2">
                        <Link
                          ...
                          className="rent-now-btn bg-yellow-400 text-black rounded-[12px] md:rounded-[18px] md:py-2 md:px-4 px-3 py-2 text-sm md:text-lg hover:bg-yellow-500 hover:shadow-lg transition duration-200"
