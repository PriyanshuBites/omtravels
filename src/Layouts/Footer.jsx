  ...
  return (
    <>
      <Container>
        ...
        <footer className="bg-black border border-black border-t-white">
            ...
            <div className="">
              <div className="flex flex-col xl:flex-row justify-between lg:items-center py-10 p-3 lg:px-0">
                <div className="logo-section flex flex-col justify-center items-center md:w-[100%] xl:w-[50%] md:px-4">
                  <Link
                    to="/"
                    className="logo flex justify-center items-center xl:mr-0 lg:ml-6 md:w-40 lg:w-[50%] w-12 mb-5 lg:mb-16"
                  >
                    <img
                      src={logo}  
                      alt="company logo"
                      className="mr-2 md:w-16 lg:w-18"
                    />
                    <h1 className="md:text-2xl lg:text-4xl font-bold text-white">
                      OmTravels
                    </h1>
                  </Link>
                  <p className="company-blog lg:mx-7 lg:text-[18px] text-white lg:leading-8 md:text-center xl:text-start">
                    OM Travels, Jabalpur's most trusted travel agency, offers
                    reliable taxi services focused on comfort, safety, and
                    customer satisfaction. Whether you're a local or a visitor,
                    OM Travels ensures a smooth, seamless travel experience.
                  </p>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-around lg:pb-16 md:mt-10 lg:mt-10 md:mb-4 w-full">
                  <div className="explore leading-7 lg:leading-10 mt-5 md:mt-0">
                    <h1 className="font-semibold text-white lg:text-lg mb-4">EXPLORE</h1>
                    <ul className="text-white flex flex-col lg:text-[18px]">
                      <Link
                        to={"/about-us"}
                        className="hover:text-blue-400 flex w-fit items-center"
                      >
                  ...
                  <div className="service leading-7 lg:leading-10 mt-5 md:mt-0">
                    <h1 className="font-semibold lg:text-lg mb-4 text-white">
                      OUR SERVICES
                    </h1>
                    <ul className="text-white flex flex-col lg:text-[18px]">
                      ...
                      >
                        <MdKeyboardDoubleArrowRight className="mr-1" />
                        Railway Reservation Consultant
                      </button>
                      <button
                        role="link"
                        onClick={handleClick2}
                  ...
                  <div className="mb-auto md:w-[200px] lg:w-auto">
                    <h1 className="font-semibold lg:text-lg mb-4 mt-5 md:mt-0 text-white">
                      ADDRESS
                    </h1>
                    <p className="flex lg:justify-center items-start text-white lg:text-[18px]">
                      {" "}
                      <FaLocationDot className="mt-1 md:mt-[-10px] mr-2 lg:mr-3 text-lg md:text-5xl lg:text-lg lg:mt-2" />
                      in front of SBI ATM, Yadav Colony,
                      <br className="lg:block hidden" /> New Adaresh Colony,
                      Jabalpur,
                      <br className="lg:block hidden" /> Madhya Pradesh, 482002
                    </p>
                    <br />
                    <p className="flex lg:justify-start items-start text-white lg:text-[18px]">
                      {" "}
                      <MdEmail className="mt-1 md:mt-2 mr-1 lg:mr-3 md:text-lg lg:mt-2" />
                      omtravels8085<br className="hidden md:block lg:hidden"/>@gmail.com
                    </p>
                    <br />
                    <p className="flex lg:justify-start items-start text-white lg:text-[18px]">
                      {" "}
                      <BsTelephoneFill className="mt-1 md:mt-0 mr-1 lg:mr-3 md:text-lg lg:mt-2" />
                      +91 9826327078
                    </p>
              ...
              <div className="flex flex-col-reverse md:px-9 md:flex-row justify-between items-center border bg-gray-900 border-gray-400 border-b-black rounded-t-[30px] shadow-xl lg:py-10 px-5">
                <div className="copyright text-white text-sm lg:text-[18px] leading-6 mb-4">
                  {/* Copyright &copy;  2024 Om Travels. All Rights Reserved. */}
                  Copyright &copy; 2026 Om Travels. All Rights Reserved.
                  {/* <p>Powered by Priyanshu Team</p> */}
                  <p>Powered by Samwayne IT</p>
                </div>
                <div className="social-icons flex justify-between w-24 lg:w-32 mt-5 mb-10 ">
                  <a
                    href="https://www.instagram.com/omtravels.jabalpur/"
                    target="_blank"
                  ...
                  <a
                    href="https://www.facebook.com/profile.php?id=100057577626007"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  ...
                  <button
                    onClick={() =>
                      openWhatsApp("917440913040", "Hi Om Travels, ")
                    }
                    href=""
                    target="_blank"
                    rel="noopener noreferrer"
